...
Overview
  ...
  FlightSearch takes a network of cities and flight connections and lets you query routes between them — think of it as a mini flight-booking search engine   r unning under the hood. Cities and flights are loaded from data files, structured into a graph, and traversed to answer real search requests.

  Built as a project for CSCI 3110, this was a chance to get hands-on with graph representations, custom data types, and file-driven program design in C++.
...
*Developed a backtracking Depth-First Search (DFS) algorithm to dynamically generate valid, cycle-free multi-
city travel itineraries and calculate total costs.
*Utilized modern C++ features—including Lambdas, operator overloading, and deep copies—to decouple data
management.

👤 Author
Arun Baraili CSCI 3110
